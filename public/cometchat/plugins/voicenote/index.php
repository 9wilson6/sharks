...
$voicenotecsstag = getDynamicScriptAndLinkTags(array('type' => "plugin",'name' => 'voicenote', 'ext' => 'css'));
$jqueryjstag =  getDynamicScriptAndLinkTags(array('type' => "core",'name' => 'jquery', 'ext' => 'js'));
$voicenotejstag = getDynamicScriptAndLinkTags(array('type' => "plugin",'name' => 'voicenote', 'ext' => 'js'));
$recorderjstag = getDynamicScriptAndLinkTags(array('type' => "plugin",'name' => 'voicenote', 'subtype' => 'recorder', 'ext' => 'js'));
$addvoicenotejstag = getDynamicScriptAndLinkTags(array('type' => "plugin",'name' => 'voicenote', 'subtype' => 'addvoicenote', 'ext' => 'js'));
