...
if (!empty($isImage) && $isImage) {
	...
	$imgtag = "(".$filename.")<img class=\"file_video\" type=\"video\" src=\"".STATIC_CDN_URL."images/videoicon.png\"/>";
} else if (!empty($isAudio) && $isAudio) {
	$imgtag = "(".$filename.")<img class=\"file_audio\" type=\"audio\" src=\"".STATIC_CDN_URL."images/audioicon.png\"/>";
}
