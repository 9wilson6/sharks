...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if(file_exists(dirname(dirname(dirname(__FILE__))).DIRECTORY_SEPARATOR.'vendor'.DIRECTORY_SEPARATOR.'autoload.php')){
...
$cipher = 'AES-128-CBC';
$mode = 'WBVp/Chcsb3CdfsUX4ff+2LqTw';
...
class Integration{
	...
	function getUserID() {
		...
		if (!empty($_COOKIE['myhomeworkshark_session'])) {
			$app = app();
			...
			if($app['auth']->user()!= NULL){
				...
				/* if(!$app['auth']->user()->hasRole('student')){
					$userid = $app['auth']->user()->id;
				} */
			}
		}
