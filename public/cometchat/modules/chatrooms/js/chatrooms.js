...
jqcc.extend(jqcc.cometchat, {
    crvariables : {themename: '<?php echo $layout;?>',
                    ...
                    jqcc.ajax({
                        ...
                        success: function(data) {
                            if (parseInt(data)!=0 && typeof data != "undefined" && data != "") {
                                ...
                                chatrooms['_'+data.id] = {'createdby':jqcc.cometchat.getUserID(),'i':room.password,'id':data.id,'j':1,'name':room.name,'online':1,'s':1,'type':room.type};
            ...
            unbanChatroomUser: function(windowmode, roomid) {
                if(typeof(roomid) == "undefined") {
                    roomid = this.crvariables.currentroom;
                }
