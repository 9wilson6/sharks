            ...
            return "<span class=\"cometchat_ts\" "+cometchat_self_ts+" "+style+">("+time.hour+":"+time.minute+time.ap+" "+time.date+time.type+" "+time.month+")</span>";
                        ...
                        if(plugins.length > 0) {
                            for (var i=0;i<plugins.length;i++) {
                                ...
                                if(settings.plugins[i] == 'audiochat'){
                                    ...
                                    /*voicenotehtml = '<div id="cometchat_recorder"><img src="'+staticCDNUrl+'layouts/'+calleeAPI+'/images/recorder.svg" class="ccplugins" title="'+$[name].getTitle()+'" name="'+name+'" to="'+roomno+'" chatroommode="1"/></div>';*/
                ...
                loadChatroomList : function(item) {
                    ...
                    $.each(item, function(i,room) {
                        ...
                        if(room.type == 1) {
                            roomtype = '<img src="'+staticCDNUrl+'layouts/'+calleeAPI+'/images/lock.png" />';
                        }
                ...
                displayChatroomMessage: function(item,fetchedUsers) {
                    ...
                    activeChatrooms: function(item){
                        ...
                        $.each(chatroomitem, function(i,room) {
                            ...
                            if((room.s == 1 || jqcc.cometchat.checkModerator() == 1) && room.createdby != 0){
                                deleteroom = '<img src="'+staticCDNUrl+'layouts/'+calleeAPI+'/images/remove.png" />';
                                renameChatroom = '<img src="'+staticCDNUrl+'layouts/'+calleeAPI+'/images/pencil_buddylist.png" />';
                            }
