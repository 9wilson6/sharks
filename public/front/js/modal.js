function ModalClass() {
    ...
    function s(e, t, o) {
        ...
        return n.open(e, t), "post" == e && "undefined" != typeof o ? (n.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), n.send(o)) : n.send(), n
    }
    var i = this;
    i.COOKIE_NAME = "popupemail_hide", i.COOKIE_EXPIRE = 90, i.waitSubmitResult = !1, i.sendAbort = !1, i.inited = !1;
    var r, a, l = 15,
        u = [],
        d = !1,
        f = !1,
    ...
    this.init = function () {
        if (void 0 == o(i.COOKIE_NAME) && (d = !0, this.inited === !1)) {
            ...
            this.inited = !0, t.onreadystatechange = function () {
                if (4 == this.readyState) {
                    if (200 != this.status) return console.log("Error: " + this.status + ". " + this.statusText), void(f = !0);
                    if (this.responseText.length <= 0) return void(f = !0);
                    var t = JSON.parse(this.responseText);
                    if ("undefined" != typeof t.location) {
                        if ("undefined" == typeof t.template || t.template.length <= 0) return void(f = !0);
        ...
        return e.setTime(o), e.toGMTString()
        ...
        e.length > 0 ? (document.getElementsByTagName("body")[0].style.overflow = "hidden", e[0].style.display = "block", f = !0, this.afterShow()) : a = setInterval(function () {
        ...
        if ("undefined" == typeof e) {
            ...
            for (var n = 0; n < o.length; n++) o[n].className = i.replaceString(o[n].className, " field-error", "")
        } else {
            this.latineOnly(e);
            ...
            e = i.getParentElement(e, "field-error"), "undefined" != typeof e.className && (e.className = i.replaceString(e.className, " field-error", ""))
        }
        ...
        if (i.removeFieldError(), 0 != d) {
            ...
            for (var a = 0; a < n.length; a++) {
                ...
                1 == Boolean(l) && c.length <= 0 ? (o = !1, p.className += " field-error") : !(c.length > 0 && "email" == u) || m.test(c) && t(c) ? c.length > 0 && "number" == u && h.test(c) ? (o = !1, p.className += " field-error") : r += "&" + f + "=" + encodeURIComponent(c) : (o = !1, p.className += " field-error")
            }
            if (1 == o) {
        ...
        "undefinrd" != typeof e.beforeShow && (this.beforeShow = e.beforeShow), "undefinrd" != typeof e.afterShow && (this.afterShow = e.afterShow), "undefinrd" != typeof e.beforeClose && (this.beforeClose = e.beforeClose), "undefinrd" != typeof e.afterClose && (this.afterClose = e.afterClose), "undefinrd" != typeof e.waitSubmitResult && (this.waitSubmitResult = e.waitSubmitResult), "undefinrd" != typeof e.customErrorMessage && (this.showErrorMessage = e.customErrorMessage), "undefinrd" != typeof e.customSuccessMessage && (this.showSuccesMessage = e.customSuccessMessage), "undefinrd" != typeof e.beforeFormSubmit && (this.beforeFormSubmit = e.beforeFormSubmit)
        ...
        var t = !1;
        for (var o in e) void 0 !== typeof i[o] && (i[o] = e[o], "COOKIE_NAME" == o && (t = !0));
        t && i.init()
    }
}
