<header class="default">
    <div class="wrapper">
        <div class="short-line">
            <a href="/" class="logo">
                <img src="{{ asset('front/img/logo_white.png') }}" class="main_white_logo" alt="logo white">
                <img src="{{ asset('front/img/logo_black.png') }}" class="main_black_logo" alt="logo black">
            </a>
