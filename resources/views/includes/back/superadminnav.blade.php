    ...
    <ul class="nav navbar-top-links navbar-right">
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                ...
                <li><a href="{{ url('/account/changepass') }}"><i class="fa fa-key fa-fw"></i> Change Password</a></li>
                <li class="divider"></li>                
                <li><a href="{{ url('/my-clearall') }}"><i class="fa fa-trash fa-fw"></i> Clear Data</a></li>
                <li><a href="{{ url('/edit-pusher') }}"><i class="fa fa-edit fa-fw"></i> Edit Pusher</a></li>
                <li class="divider"></li>
                <li><a href="{{ route('admin.settings') }}"><i class="fa fa-cog fa-fw"></i> Settings</a></li>
                <li class="divider"></li>
    ...
    <div class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="{{ route('admin.orders') }}"><i class="fa fa-users fa-2x"></i>
                        <h4>Admin users</h4>
                    </a>
                </li>
            </ul>
