<section id="home" class="dzsparallaxer auto-init dzsparallaxer---window-height use-loading"
    ...
    <div class="divimage dzsparallaxer--target " data-src="{{ asset('img/bg1.jpg') }}"
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 leftcta">
                                <div class="col-md-10">
                                    <div class="hero-static">
                                        ...
                                        <div class="buttons">
                                            <a href="{{ url('/register') }}" class="btn btn-xl btn-primary">Click to get
                                                instant help</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 orderformhome">
                                ...
                                <hr>
                                <form action="{{ route('projects.post.save') }}" method="POST" class="form-horizontal"
                                    role="form">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" maxlength="70" name="title" class="form-control"
                                                placeholder="Title">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" name="subject" id="subject">
                                                ...
                                                <option value="{{ $subject->subjects }}">{{ $subject->subjects }}
                                                </option>
                                                @endforeach
                                            </select>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary pull-right">Continue <i
