                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <input type="submit" class="btn btn-lg btn-success btn-block" name="loginin"
                                        id="loginin" value="Submit">
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <a href="../index.php/pages/register.htm"
                                        class="btn btn-lg btn-primary btn-block">New User</a>
                                </div>
                            </div>
                        </fieldset>
                    </form>
