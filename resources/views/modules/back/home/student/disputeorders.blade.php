        ...
        <table class="table table-striped table-hover">
            <tbody>
                ...
                @foreach($disputed as $dispute)
                    <tr>
                        <td>{{ $dispute->id }}</td>
                        <td><a href="{{ url('/account/studentview') }}/{{ $dispute->id }}">{{ $dispute->subject }}</a></td>
                        ...
                        <td>{{ $account->no_bid($dispute->id) }}</td>
                        <td><a class="btn btn-primary" href="{{ url('/account/studentview') }}/{{ $dispute->id }}">Details</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
