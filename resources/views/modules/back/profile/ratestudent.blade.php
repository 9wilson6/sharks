<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr>
                <td>Project Title</td>
                <td><a href="{{ url('/account/sholarview') }}/{{ $order->id }}">{{ $order->subject }}</a></td>
            </tr>
            <tr>
                <td>Student</td>
                <td>{{ $student->name }}</td>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form name="form" method="post" action="{{ url('/account/rate-student') }}">
        {{ csrf_field() }}
            <table>
                <tr>
                    <td valign="top">
            ...
            <center>
                <button class="btn btn-default" type="submit" value="Submit" id="ratepayButton">Submit</button>
            </center>
        </form>
    </div>
</div>
