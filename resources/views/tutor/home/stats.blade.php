<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="list-group">
            ...
            <a href="{{ route('tutor.refunds') }}" class="list-group-item">
                <i class="fa fa-tasks fa-fw"></i> Refunds:
                <span class="pull-right text-muted small"><em>{{ count(tutorefunds(Auth::user()->id)) }}</em>
                </span>
            </a>
        </div>
        <!-- /.list-group -->
