                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped">
                            <tr>
                                ...
                                <td>
                                    <img width="65" height="65" style="border-radius: 50%;" src="{{ asset(auth()->user()->image ?? '/img/noprofile.png') }}" alt="{{ Auth::user()->name }}">
                                </td>
                            </tr>
                            <tr>
                                <td>User</td>
                            ...
                            <tr>
                                ...
                                <td>$ {{ number_format(Auth::user()->tutorpayments->sum('amount') - Auth::user()->tutorwithdrawals->sum('amount') ,2) }}</td>
                            </tr>
                            <tr>
                                <td>About Me</td>
                                <td>
                                ...
                                <td>
                                    <ol>
                                        @foreach (Auth::user()->attachments as $attach)
                                            <li><a href="{{ route('tutor.attachments.delete', $attach->id) }}">{{ $attach->filename }}</a></li>
                                        @endforeach
                                    </ol>
                                </td>
                            </tr>
