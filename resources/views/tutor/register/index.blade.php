...
@section('title', 'Homework Bubble: Become a tutor')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-lg-3">
                    <div class="misc-box">
                        ...
                        <hr>
                        <form role="form" method="post" class="margin-b-20" action="{{ url('/registertutor') }}">
                            {{ csrf_field() }}
                    ...
                    <span class="copyright">&copy; Copyright 2016 - {{ date('Y') }}. HomeworkBubble.com</span>
                </div>
            </div>
        </div>
    </div>
