...
@section('title', 'Add tutor: '.defaultsettings()['sitename'])
@section('heading', 'Add tutor')
@section('content')
<div class="panel panel-default">
<div class="panel-heading"> Add tutor</div>
    <!-- /.panel-heading -->
    <div class="panel-body">
        <form name="form" method="post" action="{{ route('admin.tutors.store') }}">
            {{ csrf_field() }}
            ...
            <button type="submit" class="btn btn-primary btn-block btn-lg"><strong>Add tutor</strong></button>
        </form>
        <hr>
    </div>
</div>
