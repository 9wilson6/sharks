...
@section('title', 'All manual releases request: '.defaultsettings()['sitename'])
@section('heading', 'All manual releases request')
@section('content')
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading"><h4>All manual releases request</h4></div>
        <div class="panel-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    @foreach($manualreleases as $release)
                    <tr>
