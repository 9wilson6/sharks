...
<!-- Start intro -->
        @include('modules.front.front.intro')
        <!--intro section end-->
        @include('modules.front.front.features')
        <!--end features section-->
        <!--end showcase section-->
        @include('modules.front.front.testimonials')        
        <!--end testimonials section-->

        @include('modules.front.front.howitworks')
        <!--end steps-->
        @include('modules.front.front.whyus')        
        <div class="cta-skin">
