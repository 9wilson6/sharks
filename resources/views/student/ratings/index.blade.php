...
@section('title', 'Rate Tutor: '.defaultsettings()['sitename'])
@section('heading', 'Rate Tutor')
@section('content')
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-clock-o fa-fw"></i> Rate tutor
        </div>
        <div class="panel-body">
            <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                    <td>Project Title</td>
                    <td><a href="{{ route('student.order.details', $orderdetails->id) }}">{{ $orderdetails->subject }}</a></td>
                </tr>
                <tr>
                    <td>Tutor name</td>
                    <td>{{ $orderdetails->tutor->name }}</td>
                </tr>
            </table>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-clock-o fa-fw"></i> Please rate the tutor
        </div>
        <div class="panel-body">
            <h5> Please rate the Project</h5>
            <i>Fields marked with * are required </i>
            <form name="form" method="post" action="{{ route('student.rate.tutor.save', $orderdetails->id) }}">
                {{ csrf_field() }}
                <table>
                    <tr>
                        <td valign="top">
