<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <table class="table table-striped table-hover">
            <tbody>
                    @if(count($disputed) < 1)
                        <tr><em>There are no disputes yet</em></tr>
                    @else
                    <tr>
                    ...
                    <tr>
                        <td>{{ $dispute->id }}</td>
                        <td><a href="{{ route('student.order.details', $dispute->id) }}">{{ $dispute->subject }}</a></td>
                        ...
                        <td>{{ count($dispute->bids) }}</td>
                        <td><a class="btn btn-primary" href="{{ route('student.order.details', $dispute->id) }}">Details</a></td>
                    </tr>
                    @endforeach
            </tbody>
        </table>
