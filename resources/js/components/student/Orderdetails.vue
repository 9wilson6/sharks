<template>
    ...
    <div class="panel-body">
     <div class="table-responsive">
        ...
        <a v-for="(attachment, index) in orderdetails.attachments" :key="index" :href="'/home/orderuploads/get/' +attachment.order_id+ '/' +attachment.filename" class="btn btn-danger" v-else> {{ attachment.filename }} </a>
    </div>        
